                            ...
                            <div class="col-lg-9 col-md-12">
                                <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                    <div class="dash__pad-2">
                                        <div class="dash__address-header">
                                            <h1 class="dash__h1">Card Book</h1>
                                            <c:if test="${requestScope.cards.size()>0}">
                                                <div>

                                                    <span class="dash__link dash__link--black u-s-m-r-8">
                                                        <a href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.CARD_DEFAULT)}">Make default paying Card</a></span>
                                                </div>
                                            </c:if>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a class="address-book-edit btn--e-transparent-platinum-b-2"
                                                               href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.CARD_EDIT)}?card=${card.id}">Edit</a>
                                                        </td>
                                                        <td>Mastercard</td>
                                                        <td>${card.cardNumberEnds}</td>
                                                        <td>${card.expireDate}</td>
                                                        <td>${card.balance}</td>
                                                        <c:if test="${card.defaultCard==true}">
                                                            <td>
                                ...
                                <div>
                                    ...
                                    <a class="dash__custom-link btn--e-brand-b-2"
                                       href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.CARD_ADD)}"><i
                                            class="fas fa-plus u-s-m-r-8"></i>

                                        <span>Add New Card</span></a></div>
                            </div>
                        </div>
                    </div>
                </div>
