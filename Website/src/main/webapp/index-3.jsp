                ...
                <nav class="primary-nav-wrapper">
                    <div class="container">
                        ...
                        <div class="primary-nav">
                            ...
                            <a class="main-logo" href="index-3.jsp">
                                                    ...
                                                    <div class="mega-menu-list">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="index-3.jsp"><i class="fas fa-utensils u-s-m-r-6"></i>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="index-3.jsp"><i class="fas fa-couch u-s-m-r-6"></i>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="index-3.jsp"><i class="fas fa-football-ball u-s-m-r-6"></i>
                                                            ...
                                                            <li>
                                                                ...
                                                                <a href="index-3.jsp"><i class="fas fa-heartbeat u-s-m-r-6"></i>
                                ...
                                <div class="ah-lg-mode">
                                    ...
                                    <ul class="ah-list ah-list--design1 ah-list--link-color-white">
                                        <li>
                                            ...
                                            <a href="index-3.jsp"><i class="fas fa-home u-c-brand"></i></a></li>
                                        <li>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                                <div class="promotion-o">
                                    ...
                                    <div class="promotion-o__content">
                                        ...
                                        <a class="promotion-o__link btn--e-white-brand" href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.SHOP)}">Women's Clothing</a></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                                <div class="promotion-o">
                                    ...
                                    <div class="promotion-o__content">
                                        ...
                                        <a class="promotion-o__link btn--e-white-brand" href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.SHOP)}">Fashion Accessories</a></div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-6 u-s-m-b-30">
                                <div class="promotion-o">
                                    ...
                                    <div class="promotion-o__content">
                                        ...
                                        <a class="promotion-o__link btn--e-white-brand" href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.SHOP)}">Men's Clothing</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-12">
                                    ...
                                    <a class="i3-banner" href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.SHOP)}">
                                        <div class="aspect aspect--bg-grey-fb aspect--square">

                                            <img class="aspect__img i3-banner__img" src="images/banners/i3-banner-1.jpg" alt=""></div>
                                    </a></div>
                                <div class="col-lg-6 col-md-12">
                                    <div class="row">
                                            ...
                                            <div class="product-short u-h-100">
                                                <div class="product-short__container">
                                                    <div class="product-short__img-wrap">
                                                        ...
                                                        <a class="aspect aspect--bg-grey-fb aspect--square u-d-block" href="product-detail.jsp">

                                                            <img class="aspect__img product-short__img" src="images/product/women/product14.jpg" alt=""></a></div>
                                                    <div class="product-short__info">
                                                        ...
                                                        <span class="product-short__name">
                                                            ...
                                                            <a href="product-detail.jsp">Women Shoes</a></span>

                                                        <span class="product-short__category">

                                                            <a href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.SHOP)}">Women Clothing</a></span></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 u-s-m-b-30">
                                                ...
                                                <div class="product-short__container">
                                                    <div class="product-short__img-wrap">
                                                        ...
                                                        <a class="aspect aspect--bg-grey-fb aspect--square u-d-block" href="product-detail.jsp">
                                                            ...
                                                            <img class="aspect__img product-short__img" src="images/product/men/product12.jpg" alt=""></a></div>
                                                    <div class="product-short__info">
                                                        ...
                                                        <span class="product-short__name">
                                                            ...
                                                            <a href="product-detail.jsp">Men Leather Wallet</a></span>

                                                        <span class="product-short__category">

                                                            <a href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.SHOP)}">Men Clothing</a></span></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            ...
                                            <a class="i3-banner" href="${applicationScope.urlMappingConstants.getControllerUrl(PageNames.SHOP)}">
                                                <div class="aspect aspect--bg-grey-fb aspect--1048-334">
                                                    ...
                                                    <img class="aspect__img i3-banner__img" src="images/banners/i3-banner-2.jpg" alt=""></div>
                                            </a></div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="product-r__action-wrap">
                                            <ul class="product-r__action-list">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="signin.jsp"><i class="fas fa-heart"></i></a></li>
                                                <li>

                                                    <a href="signin.jsp"><i class="fas fa-envelope"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="product-r__info-wrap">
                                        ...
                                        <div class="product-r__n-p-wrap">
                                            ...
                                            <span class="product-r__name">
                                                ...
                                                <a href="product-detail.jsp">New Dress A Nice Elegant</a></span>
                                    ...
                                    <div class="product-r__info-wrap">
                                        ...
                                        <div class="product-r__n-p-wrap">
                                            ...
                                            <span class="product-r__name">
                                                ...
                                                <a href="product-detail.jsp">New Dress B Nice Elegant</a></span>
                                    ...
                                    <div class="product-r__info-wrap">
                                        ...
                                        <div class="product-r__n-p-wrap">
                                            ...
                                            <span class="product-r__name">
                                                ...
                                                <a href="product-detail.jsp">New Dress C Nice Elegant</a></span>
                                ...
                                <div class="product-r u-h-100">
                                    <div class="product-r__container">
                                        ...
                                        <a class="aspect aspect--bg-grey aspect--square u-d-block" href="product-detail.jsp">
                                            ...
                                            <img class="aspect__img" src="images/product/women/product8.jpg" alt=""></a>
                                        <div class="product-r__action-wrap">
                                            <ul class="product-r__action-list">
                                                <li>
                                    ...
                                    <div class="product-r__info-wrap">
                                        ...
                                        <div class="product-r__n-p-wrap">
                                            ...
                                            <span class="product-r__name">
                                                ...
                                                <a href="product-detail.jsp">New Fashion A Nice Elegant</a></span>
                                    ...
                                    <div class="product-r__info-wrap">
                                        ...
                                        <div class="product-r__n-p-wrap">
                                            ...
                                            <span class="product-r__name">
                                                ...
                                                <a href="product-detail.jsp">New Fashion B Nice Elegant</a></span>
                                    ...
                                    <div class="product-r__info-wrap">
                                        ...
                                        <div class="product-r__n-p-wrap">
                                            ...
                                            <span class="product-r__name">
                                                ...
                                                <a href="product-detail.jsp">New Fashion C Nice Elegant</a></span>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">Black &amp; White Sweater</a></span>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">Color Yellow Modest A Fashion</a></span>
                                                    <div class="product-bs__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">White Full Men Underwear</a></span>
                                                    <div class="product-bs__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">Color Yellow Modest B Fashion</a></span>
                                                    <div class="product-bs__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">Blown Sunglasses For Deux</a></span>
                                                    <div class="product-bs__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">Ladies Black Bag</a></span>
                                                    <div class="product-bs__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">Casual Shoes Independence</a></span>
                                                    <div class="product-bs__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                                            ...
                                            <div class="product-bs">
                                                <div class="product-bs__container">
                                                    ...
                                                    <span class="product-bs__name">
                                                        ...
                                                        <a href="product-detail.jsp">Men Casual Shoes Charcoal</a></span>
                                                    <div class="product-bs__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>
                                    ...
                                    <div class="product-short__container">
                                        <div class="product-short__img-wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey-fb aspect--square u-d-block" href="product-detail.jsp">
                                                ...
                                                <img class="aspect__img product-short__img" src="images/product/women/product16.jpg" alt=""></a></div>
                                        <div class="product-short__info">
                                    ...
                                    <div class="product-short__container">
                                        <div class="product-short__img-wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey-fb aspect--square u-d-block" href="product-detail.jsp">
                                                ...
                                                <img class="aspect__img product-short__img" src="images/product/women/product17.jpg" alt=""></a></div>
                                        <div class="product-short__info">
                                    ...
                                    <div class="product-short__container">
                                        <div class="product-short__img-wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey-fb aspect--square u-d-block" href="product-detail.jsp">
                                                ...
                                                <img class="aspect__img product-short__img" src="images/product/women/product18.jpg" alt=""></a></div>
                                        <div class="product-short__info">
                                    ...
                                    <div class="product-short__container">
                                        <div class="product-short__img-wrap">
                                            ...
                                            <a class="aspect aspect--bg-grey-fb aspect--square u-d-block" href="product-detail.jsp">
                                                ...
                                                <img class="aspect__img product-short__img" src="images/product/women/product19.jpg" alt=""></a></div>
                                        <div class="product-short__info">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/men/product9.jpg" alt=""></a></div>
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/men/product10.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/women/product9.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/women/product10.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/women/product11.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/women/product12.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/women/product13.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="product-detail.jsp">New Dress E Nice Elegant</a></span>
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/women/product1.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                                    <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i></div>
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="product-detail.jsp">Women intimate Bra</a></span>
                                            ...
                                            <div class="product-l">
                                                <div class="product-l__img-wrap">
                                                    ...
                                                    <a class="aspect aspect--bg-grey aspect--square u-d-block product-l__link" href="product-detail.jsp">
                                                        ...
                                                        <img class="aspect__img" src="images/product/women/product2.jpg" alt=""></a></div>
                                                <div class="product-l__info-wrap">
                                                    <div class="product-l__rating gl-rating-style"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i><i class="far fa-star"></i></div>
                                                    ...
                                                    <span class="product-l__name">
                                                        ...
                                                        <a href="product-detail.jsp">Women Wedding Event Dress</a></span>
                                        ...
                                        <div class="outer-footer__list-wrap">
                                            ...
                                            <ul>
                                                ...
                                                <li>
                                                    ...
                                                    <a href="index-3.jsp">Sitemap</a></li>
                                                <li>
