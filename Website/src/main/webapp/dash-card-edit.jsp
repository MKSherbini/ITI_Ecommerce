                            ...
                            <div class="col-lg-9 col-md-12">
                                <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                    <div class="dash__pad-2">
                                        <h1 class="dash__h1 u-s-m-b-14">Edit Card</h1>

                                        <span class="dash__text u-s-m-b-30">Are you sure you want to delete this card.</span>
                                            ...
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
                                                    ...
                                                    <input class="input-text input-text--primary-style" type="tel"
                                                           ...
                                                           value="Master card ending with ${requestScope.card.cardNumberEnds}"
                                                           disabled></div>
                                            </div>
                                            <input type="hidden" value="${requestScope.card.id}" name="card">
                                            <button class="btn btn--e-brand-b-2" type="submit">DELETE</button>
                                        </form>
