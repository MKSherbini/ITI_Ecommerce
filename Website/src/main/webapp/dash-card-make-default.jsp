                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-12">
                                <form class="dash__address-make" method="post">
                                    <div class="dash__box dash__box--shadow dash__box--bg-white dash__box--radius u-s-m-b-30">
                                        <h2 class="dash__h2 u-s-p-xy-20">Make default paying card</h2>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div class="radio-box">
                                                                ...
                                                                <input type="radio" id="card-${card.id}"
                                                                <c:if test="${card.defaultCard==true}">
                                                                       class="checkThis"</c:if>
